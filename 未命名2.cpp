...
int main()
{
 ...
 int i=0,j=0;
	...
	for(int i=0;i<5;i++)
	{
		shuchu<<student[i].college<<student[i].major<<student[i].number<<student[i].name<<student[i].sex<<student[i].sum<<endl;
		
	} 	
	for(int i=0;i<5;i++)
	{
		cout<<student[i].college<<student[i].major<<student[i].number<<student[i].name<<student[i].sex<<student[i].sum<<endl;
